...
/*
script completo con dos modos:

RUN_THRESHOLD_QA_ONLY = false → funcionamiento normal, exporta rásteres
RUN_THRESHOLD_QA_ONLY = true → no exporta rásteres, exporta una tabla CSV con:
umbral Otsu original
umbral Otsu safe
diferencia entre ambos
disponibilidad de DW y S1
área de no-data de DW
área realmente cubierta por S1 en esas zonas
contribución final de DW y S1 al agua mapeada
flag de meses con solo DW

He dejado también las opciones:

QA_INCLUDE_AREA_DIAGNOSTICS
QA_INCLUDE_OUTPUT_DIFFERENCE
*/
